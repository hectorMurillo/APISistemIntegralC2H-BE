...
namespace DA.C2H
{
    public class DAReportes
    {
        ...
        public Result<List<RptAuxiliares>> ObtenerReporteNotas(string codCliente, int codVendedor, DateTime fechaDesde, DateTime fechaHasta)
        {
            Result<List<RptAuxiliares>> result = new Result<List<RptAuxiliares>>();
            try
            {
                var parametros = new ConexionParameters();
                parametros.Add("@pCliente", ConexionDbType.VarChar, codCliente);
                parametros.Add("@pCodVendedor", ConexionDbType.Int, codVendedor);
                parametros.Add("@pFechaDesde", ConexionDbType.Date, fechaDesde);
                parametros.Add("@pFechaHasta", ConexionDbType.Date, fechaHasta);
                parametros.Add("@pResultado", ConexionDbType.Bit, System.Data.ParameterDirection.Output);
                ...
                result = _conexion.ExecuteWithResults<RptAuxiliares>("ProcReporteNotasCon", parametros);
                result.Value = parametros.Value("@pResultado").ToBoolean();
                result.Message = parametros.Value("@pMsg").ToString();
        ...
        public Result<List<RptAuxiliares>> ObtenerReporteNotasCanceladas(string codCliente, int codVendedor, DateTime fechaDesde, DateTime fechaHasta)
        {
            Result<List<RptAuxiliares>> result = new Result<List<RptAuxiliares>>();
            try
            {
                ...
                result = _conexion.ExecuteWithResults<RptAuxiliares>("ProcReporteNotasCanceladasCon", parametros);
                result.Value = parametros.Value("@pResultado").ToBoolean();
                result.Message = parametros.Value("@pMsg").ToString();
        ...
        public Result<List<RptAuxiliares>> ObtenerReporteNotasNocturnas(string codCliente, int codVendedor, DateTime fechaDesde, DateTime fechaHasta)
        {
            Result<List<RptAuxiliares>> result = new Result<List<RptAuxiliares>>();
            try
            {
                ...
                result = _conexion.ExecuteWithResults<RptAuxiliares>("ProcReporteNotasNocturnasCon", parametros);
                result.Value = parametros.Value("@pResultado").ToBoolean();
                result.Message = parametros.Value("@pMsg").ToString();
        ...
        public Result<List<RptAuxiliares>> ObtenerReporteNotasForaneas(string codCliente, int codVendedor, DateTime fechaDesde, DateTime fechaHasta)
        {
            Result<List<RptAuxiliares>> result = new Result<List<RptAuxiliares>>();
            try
            {
                ...
                result = _conexion.ExecuteWithResults<RptAuxiliares>("ProcReporteNotasForaneasCon", parametros);
                result.Value = parametros.Value("@pResultado").ToBoolean();
                result.Message = parametros.Value("@pMsg").ToString();
