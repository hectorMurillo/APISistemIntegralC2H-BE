...
namespace Models
{
    public class Globales
    {
        ...
        //BD Coki Conexión
        public static string ConexionPrincipal => @"Data Source=np:\\.\pipe\LOCALDB#7995D330\tsql\query;Initial Catalog=PruebasBeforeProduction;Integrated Security=True";
