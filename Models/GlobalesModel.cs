...
namespace Models
{
    public class Globales
    {
        ...
        //BD Coki Conexión
        public static string ConexionPrincipal => @"Data Source=np:\\.\pipe\LOCALDB#3FFD88F9\tsql\query;Initial Catalog=PruebasBeforeProduction;Integrated Security=True";
