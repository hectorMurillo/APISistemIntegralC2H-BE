...
namespace Models
{
    public class Globales
    {
        ...
        //Conexion pruebas
        //public static string ConexionPrincipal => @"data source=SQL5081.site4now.net; Initial Catalog = DB_A55757_prueba; User Id = DB_A55757_prueba_admin; Password=_C0NCR3T05D0SH";

        //local
        public static string ConexionPrincipal => @"data source=DESKTOP-KT65TI9\SQLEXPRESS;initial catalog=DB_A55757_c2h;persist security info=True;user id=sa;password=123;";
